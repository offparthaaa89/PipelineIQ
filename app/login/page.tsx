...
const loginBenefits = [
  "Continue managing your companies, contacts, and deals.",
  "Review open pipeline value and recent opportunities.",
  "Move deals through stages without losing sales context.",
];
        ...
        <section className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-[1fr_460px]">
          <div className="auth-reveal max-w-3xl">
            <p className="mb-5 inline-flex rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-sm font-semibold text-cyan-300">
              Welcome back to PipelineIQ
            </p>

            <h1 className="text-5xl font-black tracking-tight md:text-7xl">
              Pick up your pipeline exactly where you left it.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-400">
              Log in to review your dashboard, update deal stages, manage
              customer records, and keep your sales workflow moving forward.
            </p>
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                          Check pipeline, update stage, close faster
                        </p>
                      </div>

                      <p className="font-black text-cyan-300">₹2.1L</p>
                    </div>

                    <div className="mt-4 h-2 overflow-hidden rounded-full bg-slate-800">
                      <div className="auth-pulse-bar h-full w-3/4 rounded-full bg-cyan-400" />
                    </div>
                  </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                      ...
                      <p className="mt-1 font-bold text-white">Review</p>
                    </div>

                    <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                      <p className="text-xs text-slate-500">Pipeline</p>
                      <p className="mt-1 font-bold text-white">Move</p>
                    </div>

                    <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                      <p className="text-xs text-slate-500">Dashboard</p>
                      <p className="mt-1 font-bold text-white">Track</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="mb-7">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Continue managing your companies, contacts, deals, and pipeline
                stages from your secure CRM dashboard.
              </p>
            </div>
            ...
            <p className="mt-5 text-center text-xs leading-5 text-slate-600">
              Your dashboard is protected by authentication and user-scoped CRM
              records.
            </p>
          </form>
        </section>
